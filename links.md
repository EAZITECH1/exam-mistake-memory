...
- MCP overview + tools: https://docs.wal.app/walrus-memory/mcp/overview
- Claude Code setup: https://docs.wal.app/walrus-memory/mcp/claude-code
- MemWal repo: https://github.com/MystenLabs/MemWal

## Community
- Walrus Discord: https://discord.com/invite/walrusprotocol
- Walrus X: https://x.com/walrusprotocol
